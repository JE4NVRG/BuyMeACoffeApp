        ...
        return (
            <div style={{
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                    <label style={{ fontSize: "1.15rem"}}>Faça a sua Doação</label>
                    <p style={{ fontSize: "10px", color: "#888", marginBottom: "0.5rem"}}>** Deve ser maior que 0..</p>
                    <input 
                        type="number" 
                        value={buyAmount}
                    ...
                    />
                    <label style={{ fontSize: "1.15rem", marginBottom: "0.5rem"}}>Mensagem</label>
                    <input 
                        type="text" 
                        value={message}
                    ...
                    {message && buyAmount > 0 && (
                        <TransactionButton
                            ...
                            onTransactionConfirmed={() => {
                                alert("Obrigado Pelo seu cafezinho !")
                                setBuyAmount(0);
                                setMessage("");
                                refetchTotalCoffees();
                ...
                <div>
                    <h3 style={{ marginBottom: "1rem"}}>Total Cafes: {totalCoffees?.toString()}</h3>
                    <p style={{ fontSize: "1.15rem" }}>Recentes Doacoes:</p>
